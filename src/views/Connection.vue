<template>
  <div ref="pageRef" class="page">
    ...
    <!-- Transport dead (RKN blackhole / server blocked): DNS calibration cannot fix it -->
    ...
    <Transition name="fade-up">
      <div
        v-if="vpnStore.sessionSeconds >= 5 && vpnStore.status.connected && !vpnStore.dnsCalibrating && !vpnStore.dnsProbing && !vpnStore.currentPingMs && !vpnStore.suggestDnsFix && !vpnStore.tunnelBlocked"
        class="calib-row"
      >
    ...
    <Transition name="fade-up">
      <div v-if="vpnStore.sessionSeconds >= 5 && vpnStore.suggestDnsFix && vpnStore.status.connected" class="calib-row calib-row--warn">
        <ShieldAlert :size="13" class="calib-row-icon" />
